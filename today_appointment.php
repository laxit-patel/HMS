...
$result_dr = fetch_data("select doctor_name,doctor_id from doctor where doctor_exist = 0","result");
$result_slot = fetch_data("select * from slot","result");
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Dashboard<i class="pe-7s-angle-right"></i>Todays Appointment</a>
                </div>
        ...
        <div class="container-fluid">
          ...
          <h4> $alert_danger </h4>
                                ...
                                <div class="wizard-navigation">
                                    <ul>
                                        <li><a href="#about" data-toggle="tab">Doctor</a></li>

                                        <li><a href="#address" data-toggle="tab">Slot</a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="tab-content">
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Choose Doctor</label>
                                                    <select name="todays_doctor" class="form-control" id="todays_doctor">

                                                        <option disabled="" selected=""></option>
                                                        <?php if($result_p)
                                                        {

                                                            while($row = mysqli_fetch_array($result_dr)) {
                                                                echo "<option >".$row["doctor_id"]."->".$row["doctor_name"]."</option>";
                                                            }
                                                        } ?>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="fresh-table <?php theme("class_table"); ?>" >
                                                            ...
                                                            <table id="fresh-table" class="table">
                                                                <thead>
                                                                <th data-field="id">Patient</th>
                                                                <th data-field="name" data-sortable="true">Slot</th>
                                    ...
                                    <div class="tab-pane" id="address">
                                        ...
                                        <div class="input-group">
                                                ...
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Choose Slot</label>
                                                    <select name="todays_doctor" class="form-control" id="todays_slot">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="fresh-table <?php theme("class_table"); ?>" >
                                                            ...
                                                            <table id="fresh-table " class="table">
                                                                ...
                                                                <th data-field="name" data-sortable="true">Patient</th>
...
<!-- todays appointment -->
<script src="assets/js/todays_appointment.js"></script>

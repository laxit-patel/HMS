...
<head>
    ...
    <title>Dashboard - Discharge</title>
...
<div class="wrapper">
    ...
    <?php menu($data["admin_name"],"patient","discharge_patient"); ?>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Dashboard<i class="pe-7s-angle-right"></i>Discharge</a>
                </div>

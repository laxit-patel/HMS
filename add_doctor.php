                            ...
                            <form name="add_patient" method="POST">
                                ...
                                <div class="wizard-footer">
                                    <div class="pull-right">
                                        <input type='' class='btn btn-next btn-fill ' name='next' value='Next' id="<?php theme("id_btn"); ?>"/>
                                        <input type='submit' class='btn btn-finish btn-fill btn-success btn-wd ' value='Add' id="<?php theme("id_btn"); ?>" />
                                    </div>
